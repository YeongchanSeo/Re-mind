...
//		Tree tree = new Tree();
		...
		try {
			...
			System.out.println(model.getChild(root.getFirstChild(), 5));
			//The Java Language Specification媛� 
	...
	protected static void parseTreeNode(DefaultMutableTreeNode treeNode,
			Document doc) {
...
//		System.out.println(value);
		...
		while (kiddies.hasMoreElements()) {
			...
			DefaultMutableTreeNode child = (DefaultMutableTreeNode) kiddies
					.nextElement();
	...
	protected static void createNodes(DefaultMutableTreeNode top) {
		...
		category = new DefaultMutableTreeNode(new BookCatagory(
